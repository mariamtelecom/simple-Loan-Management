...
export const translations = {
  bn: {
    ...
    fatherName: "সদস্যের পিতার নাম",
    fatherMotherSpouse: "সদস্যের পিতার / স্ত্রী / স্বামীর নাম",
    selectRelationType: "সম্পর্ক নির্বাচন করুন",
    fatherSpouseAddress: "পিতা / স্ত্রী / স্বামীর ঠিকানা",
    fatherSpouseNid: "পিতা / স্ত্রী / স্বামীর NID নম্বর",
    fatherSpousePhone: "পিতা / স্ত্রী / স্বামীর ফোন নম্বর",
    ...
    guarantorSection: "জামিনদারের বিস্তারিত তথ্য (Guarantor Info)",
    guarantorName: "জামিনদারের নাম",
    guarantorFatherMotherSpouse: "জামিনদারের পিতা / মাতা / স্ত্রী / স্বামীর নাম",
    ...
    enterAmount: "টাকার পরিমাণ বসান",
    enterInstallmentNo: "কিস্তি নম্বর",
  ...
  en: {
    ...
    fatherName: "Member's Father Name",
    fatherMotherSpouse: "Father / Spouse Name",
    selectRelationType: "Select Relation Type",
    fatherSpouseAddress: "Father / Spouse Address (Thikana)",
    fatherSpouseNid: "Father / Spouse NID Number",
    fatherSpousePhone: "Father / Spouse Phone Number",
    ...
    guarantorFatherMotherSpouse: "Guarantor's Father / Mother / Spouse Name",
    guarantorMobile: "Guarantor Mobile",
    guarantorAddress: "Guarantor Address",
    guarantorNid: "Guarantor NID Number",
    ...
    enterAmount: "Takar Poriman Bosan / Enter Amount",
    enterInstallmentNo: "Installment No",
