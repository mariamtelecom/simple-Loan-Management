...
export const LoginPage: React.FC<LoginPageProps> = ({ 
  ...
  const getBengaliErrorMessage = (errCode: string, defaultMessage: string): string => {
    if (errCode.includes('auth/unauthorized-email')) return 'অনুমতি প্রত্যাখ্যান: আপনার ইমেইল দিয়ে এই সিস্টেমে প্রবেশের অনুমতি দেওয়া নেই।';
  ...
  const handleGoogleClick = async () => {
    ...
    try {
      ...
      if (code === 'auth/unauthorized-email') {
        setErrorMsg('অনুমতি প্রত্যাখ্যান: আপনার ইমেইল দিয়ে লগইন করার অনুমতি দেওয়া নেই।');
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.securityNote}>
          <Lock size={12} />
          <span>🔒 সংরক্ষিত ও সুরক্ষিত এক্সেস (অনুমোদিত ডেভলপার ও এডমিন)</span>
        </div>
      </div>
    </div>
  );
